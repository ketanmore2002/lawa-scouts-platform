...
We translate the async driver URL (postgresql+asyncpg://) to a sync one
(postgresql+psycopg2://) so Alembic can run in regular sync mode. This is
the simpler, well-trodden path.
"""
